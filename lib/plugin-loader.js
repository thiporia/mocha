...
class PluginLoader {
   ...
   * @param {PluginDefinition[]} [pluginDefinitions=MochaPlugins] - Plugin definitions
   */
  constructor(pluginDefinitions = MochaPlugins) {
    ...
    debug('registered %d plugin defs', this.registered.size);
  }
   ...
   * @param {PluginDefinition[]} [pluginDefs] - Plugin definitions
   */
